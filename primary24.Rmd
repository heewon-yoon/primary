...
feols(pri1 ~ vs_1_p | district^party + congress, cluster = ~ district, data) #* but negative
feols(pri1 ~ avg_vs2_p | district^party + congress, cluster = ~ district, data) #*
feols(pri1 ~ avg_vs3_p | district^party + congress, cluster = ~ district, data) #.
feols(pri1 ~ avg_vs4_p | district^party + congress, cluster = ~ district, data) #**
feols(pri1 ~ win4 | district^party + congress, cluster = ~ district, data)
feols(pri1 ~ win3 | district^party + congress, cluster = ~ district, data)
feols(pri1 ~ win2 | district^party + congress, cluster = ~ district, data)
feols(pri1 ~ mar23 | district^party + congress, cluster = ~ district, data)
feols(pri1 ~ mar23p | district^party + congress, cluster = ~ district, data)
feols(pri1 ~ mar_cont | district^party + congress, cluster = ~ district, data)
feols(pri1 ~ mar_cont2 | district^party + congress, cluster = ~ district, data)
