...
csm_long$type <- factor(csm_long$type, levels = c("pct.open", "pct.close", "pct.non"))

ggplot(csm_long, aes(x = as.factor(year), y = percentage, fill = type)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "Election Year", y = "Percentage") +
  theme(legend.position = "bottom", legend.title = element_blank()) +
  scale_fill_manual(labels = c("Primary", "Party Nomination", "None"),
                    values = c("coral", "cadetblue", "grey")) 
...
ggplot(map) + geom_sf(aes(fill = pri2, geometry = geometry)) + 
  scale_fill_manual(name = "Nomination Method",
                     labels = c("Centralized", "Primary"),
                     values = c("steelblue3", "darkgoldenrod2")) + 
